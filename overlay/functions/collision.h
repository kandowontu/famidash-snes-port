...
char bg_coll_slope() {	
	...
	/* SNES port: the original dispatched through a GCC computed-goto label
	   table. Calypsi 5.18 parses that extension but cannot lower it for 65816
	   and raises an internal compiler error. This switch dispatches to exactly
	   the same labels in the same table order; every label body below is
	   unchanged, and the case values are the original array indices. */
	switch (collision) {
		case 0x0B: goto col_slope_RD45;
		case 0x0C: goto col_slope_LD45;
		case 0x0D: goto col_slope_RD22_RIGHT;
		case 0x0E: goto col_slope_LD22_RIGHT;
		case 0x0F: goto col_slope_RD22_LEFT;
		case 0x10: goto col_slope_LD22_LEFT;
		case 0x11: goto col_slope_RD66_TOP;
		case 0x12: goto col_slope_LD66_TOP;
		case 0x13: goto col_slope_RD66_BOT;
		case 0x14: goto col_slope_LD66_BOT;
		case 0x15: goto col_slope_RU45;
		case 0x16: goto col_slope_LU45;
		case 0x17: goto col_slope_RU22_LEFT;
		case 0x18: goto col_slope_RU22_RIGHT;
		case 0x19: goto col_slope_LU22_LEFT;
		case 0x1A: goto col_slope_LU22_RIGHT;
		case 0x1B: goto col_slope_RU66_TOP;
		case 0x1C: goto col_slope_LU66_TOP;
		case 0x1D: goto col_slope_RU66_BOT;
		case 0x1E: goto col_slope_LU66_BOT;
		default: goto col_default;
	}
